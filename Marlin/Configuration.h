...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80.4869,80.4869,1515.1315,580}                    // default steps per unit for customized Printerbot LC with GT2 belt and acme screws
...
//When using an LCD, display the Filament sensor data on the last line instead of status.  Status will appear for 5 sec.
